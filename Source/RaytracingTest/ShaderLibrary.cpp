...
ShaderLibrary::ShaderLibrary(const App& app, const std::string& directoryPath)
{
    ...
    accumulatePS = app.device.nvrhi->createShader(nvrhi::ShaderDesc(nvrhi::ShaderType::Pixel), SHADER_ACCUMULATE_PS, sizeof(SHADER_ACCUMULATE_PS));
