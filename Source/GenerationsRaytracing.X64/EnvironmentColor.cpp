...
static const xxHashMap<std::array<uint8_t, 3>> s_environmentColors =
{
...
bool EnvironmentColor::get(const GlobalsPS& globalsPS, float* result)
{
    XXH64_hash_t hash = 0;
    ...
    if (pair == s_environmentColors.end())
        return false;
