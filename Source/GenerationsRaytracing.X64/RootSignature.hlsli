...
DEFINE_TEXTURE(Texture2D<float4>, g_ColorBeforeTransparency, 25);
DEFINE_TEXTURE(Texture2D<float3>, g_DiffuseAlbedoBeforeTransparency, 26);
DEFINE_TEXTURE(Texture2D<float3>, g_SpecularAlbedoBeforeTransparency, 27);
