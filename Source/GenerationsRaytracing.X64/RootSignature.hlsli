...
RWTexture2DArray<float> g_Shadow : register(u11);

RWTexture2D<float4> g_DiffuseAlbedo : register(u12);
RWTexture2D<float4> g_SpecularAlbedo : register(u13);
RWTexture2D<float4> g_NormalsRoughness : register(u14);
RWTexture2D<float4> g_ReflectedAlbedo : register(u15);
