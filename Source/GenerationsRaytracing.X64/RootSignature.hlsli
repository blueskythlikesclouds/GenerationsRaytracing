...
RWTexture2D<float3> g_PrevNormalTexture : register(u8);
RWTexture2D<float3> g_FalloffTexture : register(u9);
RWTexture2D<float3> g_EmissionTexture : register(u10);

RWTexture2D<float> g_ShadowTexture : register(u11);

RWTexture2D<float4> g_DIReservoirTexture : register(u12);
RWTexture2D<float4> g_PrevDIReservoirTexture : register(u13);

RWTexture2D<float3> g_GITexture : register(u14);
RWTexture2D<float3> g_GIPositionTexture : register(u15);
RWTexture2D<float3> g_GIReservoirTexture : register(u16);
