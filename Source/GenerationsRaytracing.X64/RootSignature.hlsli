...
RWTexture2D<float3> g_TransColorTexture : register(u14);

RWTexture2D<float> g_ShadowTexture : register(u15);

RWTexture2D<float4> g_DIReservoirTexture : register(u16);
RWTexture2D<float4> g_PrevDIReservoirTexture : register(u17);

RWTexture2D<float3> g_GITexture : register(u18);
