...
#define HIT_GROUP_SECONDARY_GBUFFER		         3
#define HIT_GROUP_NUM                            4
										         
#define MISS_PRIMARY                             0
#define MISS_PRIMARY_TRANSPARENT                 1
#define MISS_SECONDARY                           2
#define MISS_SECONDARY_GBUFFER                   3
#define MISS_SECONDARY_ENVIRONMENT_COLOR         4
#define MISS_SECONDARY_GBUFFER_ENVIRONMENT_COLOR 5
#define MISS_NUM								 6
