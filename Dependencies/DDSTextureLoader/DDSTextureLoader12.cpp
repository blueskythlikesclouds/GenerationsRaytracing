...
#undef ISBITMASK
    ...
    HRESULT CreateTextureResource(
        ...
        _Outptr_ ID3D12Resource** resource) noexcept
    {
        if (!d3dDevice)
            return E_POINTER;
        ...
        nvrhi::RefCountPtr<ID3D12Resource> d3d12Resource;
        ...
        {
            ID3D12Device* d3d12Device = d3dDevice->getNativeObject(nvrhi::ObjectTypes::D3D12_Device);
        ...
        constexpr std::pair<nvrhi::Format, DXGI_FORMAT> FORMAT_MAPPING[] =
        {
            ...
            { nvrhi::Format::R8_UNORM,          DXGI_FORMAT_R8_UNORM            },
            { nvrhi::Format::R8_SNORM,          DXGI_FORMAT_R8_SNORM            },
            { nvrhi::Format::RG8_UINT,          DXGI_FORMAT_R8G8_UINT           },
            { nvrhi::Format::RG8_SINT,          DXGI_FORMAT_R8G8_SINT           },
            { nvrhi::Format::RG8_UNORM,         DXGI_FORMAT_R8G8_UNORM          },
            { nvrhi::Format::RG8_SNORM,         DXGI_FORMAT_R8G8_SNORM          },
            { nvrhi::Format::R16_UINT,          DXGI_FORMAT_R16_UINT            },
            { nvrhi::Format::R16_SINT,          DXGI_FORMAT_R16_SINT            },
            { nvrhi::Format::R16_UNORM,         DXGI_FORMAT_R16_UNORM           },
            { nvrhi::Format::R16_SNORM,         DXGI_FORMAT_R16_SNORM           },
            { nvrhi::Format::R16_FLOAT,         DXGI_FORMAT_R16_FLOAT           },
            { nvrhi::Format::BGRA4_UNORM,       DXGI_FORMAT_B4G4R4A4_UNORM      },
            { nvrhi::Format::B5G6R5_UNORM,      DXGI_FORMAT_B5G6R5_UNORM        },
            { nvrhi::Format::B5G5R5A1_UNORM,    DXGI_FORMAT_B5G5R5A1_UNORM      },
            { nvrhi::Format::RGBA8_UINT,        DXGI_FORMAT_R8G8B8A8_UINT       },
            { nvrhi::Format::RGBA8_SINT,        DXGI_FORMAT_R8G8B8A8_SINT       },
            { nvrhi::Format::RGBA8_UNORM,       DXGI_FORMAT_R8G8B8A8_UNORM      },
            { nvrhi::Format::RGBA8_SNORM,       DXGI_FORMAT_R8G8B8A8_SNORM      },
            { nvrhi::Format::BGRA8_UNORM,       DXGI_FORMAT_B8G8R8A8_UNORM      },
            { nvrhi::Format::SRGBA8_UNORM,      DXGI_FORMAT_R8G8B8A8_UNORM_SRGB },
            { nvrhi::Format::SBGRA8_UNORM,      DXGI_FORMAT_B8G8R8A8_UNORM_SRGB },
            { nvrhi::Format::R10G10B10A2_UNORM, DXGI_FORMAT_R10G10B10A2_UNORM   },
            { nvrhi::Format::R11G11B10_FLOAT,   DXGI_FORMAT_R11G11B10_FLOAT     },
            { nvrhi::Format::RG16_UINT,         DXGI_FORMAT_R16G16_UINT         },
            { nvrhi::Format::RG16_SINT,         DXGI_FORMAT_R16G16_SINT         },
            { nvrhi::Format::RG16_UNORM,        DXGI_FORMAT_R16G16_UNORM        },
            { nvrhi::Format::RG16_SNORM,        DXGI_FORMAT_R16G16_SNORM        },
            { nvrhi::Format::RG16_FLOAT,        DXGI_FORMAT_R16G16_FLOAT        },
            { nvrhi::Format::R32_UINT,          DXGI_FORMAT_R32_UINT            },
            { nvrhi::Format::R32_SINT,          DXGI_FORMAT_R32_SINT            },
            { nvrhi::Format::R32_FLOAT,         DXGI_FORMAT_R32_FLOAT           },
            { nvrhi::Format::RGBA16_UINT,       DXGI_FORMAT_R16G16B16A16_UINT   },
            { nvrhi::Format::RGBA16_SINT,       DXGI_FORMAT_R16G16B16A16_SINT   },
            { nvrhi::Format::RGBA16_FLOAT,      DXGI_FORMAT_R16G16B16A16_FLOAT  },
            { nvrhi::Format::RGBA16_UNORM,      DXGI_FORMAT_R16G16B16A16_UNORM  },
            { nvrhi::Format::RGBA16_SNORM,      DXGI_FORMAT_R16G16B16A16_SNORM  },
            { nvrhi::Format::RG32_UINT,         DXGI_FORMAT_R32G32_UINT         },
            { nvrhi::Format::RG32_SINT,         DXGI_FORMAT_R32G32_SINT         },
            { nvrhi::Format::RG32_FLOAT,        DXGI_FORMAT_R32G32_FLOAT        },
            { nvrhi::Format::RGB32_UINT,        DXGI_FORMAT_R32G32B32_UINT      },
            { nvrhi::Format::RGB32_SINT,        DXGI_FORMAT_R32G32B32_SINT      },
            { nvrhi::Format::RGB32_FLOAT,       DXGI_FORMAT_R32G32B32_FLOAT     },
            { nvrhi::Format::RGBA32_UINT,       DXGI_FORMAT_R32G32B32A32_UINT   },
            { nvrhi::Format::RGBA32_SINT,       DXGI_FORMAT_R32G32B32A32_SINT   },
            { nvrhi::Format::RGBA32_FLOAT,      DXGI_FORMAT_R32G32B32A32_FLOAT  },
            { nvrhi::Format::BC1_UNORM,         DXGI_FORMAT_BC1_UNORM           },
            { nvrhi::Format::BC1_UNORM_SRGB,    DXGI_FORMAT_BC1_UNORM_SRGB      },
            { nvrhi::Format::BC2_UNORM,         DXGI_FORMAT_BC2_UNORM           },
            { nvrhi::Format::BC2_UNORM_SRGB,    DXGI_FORMAT_BC2_UNORM_SRGB      },
            { nvrhi::Format::BC3_UNORM,         DXGI_FORMAT_BC3_UNORM           },
            { nvrhi::Format::BC3_UNORM_SRGB,    DXGI_FORMAT_BC3_UNORM_SRGB      },
            { nvrhi::Format::BC4_UNORM,         DXGI_FORMAT_BC4_UNORM           },
            { nvrhi::Format::BC4_SNORM,         DXGI_FORMAT_BC4_SNORM           },
            { nvrhi::Format::BC5_UNORM,         DXGI_FORMAT_BC5_UNORM           },
            { nvrhi::Format::BC5_SNORM,         DXGI_FORMAT_BC5_SNORM           },
            { nvrhi::Format::BC6H_UFLOAT,       DXGI_FORMAT_BC6H_UF16           },
            { nvrhi::Format::BC6H_SFLOAT,       DXGI_FORMAT_BC6H_SF16           },
            { nvrhi::Format::BC7_UNORM,         DXGI_FORMAT_BC7_UNORM           },
            { nvrhi::Format::BC7_UNORM_SRGB,    DXGI_FORMAT_BC7_UNORM_SRGB      }
        };                                      
        ...
        *texture = d3dDevice->createHandleForNativeTexture(nvrhi::ObjectTypes::D3D12_Resource, d3d12Resource.Get(), textureDesc);

        if (resource)
            *resource = d3d12Resource.Detach();
        ...
        std::vector<D3D12_SUBRESOURCE_DATA>& subresources) noexcept(false)
    {
        ...
        const UINT numberOfPlanes = D3D12GetFormatPlaneCount(d3dDevice->getNativeObject(nvrhi::ObjectTypes::D3D12_Device), format);
        if (!numberOfPlanes)
            return E_INVALIDARG;
        ...
        if (SUCCEEDED(hr))
        {
            ...
            hr = CreateTextureResource(d3dDevice, allocator, resDim, twidth, theight, tdepth, reservedMips - skipMip, arraySize,
                format, resFlags, loadFlags, isCubeMap, texture, allocation, resource);
    ...
    DDS_ALPHA_MODE* alphaMode)
{
    ...
    hr = CreateTextureFromDDS(d3dDevice, allocator,
        ...
        resFlags, loadFlags,
        texture, allocation, resource, subresources);
    if (SUCCEEDED(hr))
    {
        if (alphaMode)
